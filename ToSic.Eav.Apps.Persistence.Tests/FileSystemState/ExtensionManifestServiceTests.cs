...
namespace ToSic.Eav.Apps.Persistence.Tests.FileSystemState;

/// <summary>
/// Unit tests for ExtensionManifestService serialization behavior
/// </summary>
public class ExtensionManifestServiceTests : TestBaseEav, IDisposable
{
    ...
    public ExtensionManifestServiceTests()
    {
        ...
        _service = GetService<ExtensionManifestService>();
    }
