...
public class CacheAllStreamsTest(DataSourcesTstBuilder dsSvc, IListCacheSvc listCache, DataTablePerson personTable)
{
    ...
    public void CheckSourceExpiry()
    {
        ...
        var results1 = query.GetStreamTac(DataSourceConstants.StreamDefaultName)!.ListTac();
        ...
        var listFromCache2 = cache2.GetStreamTac(DataSourceConstants.StreamDefaultName)!.ListTac();
    ...
    public void IgnoreSourceExpiry()
    {
        ...
        // Get first list from direct query and from cache - compare. Should be same
        var result = cacheAllDs1.GetStreamTac(DataSourceConstants.StreamDefaultName)!.ListTac();
        ...
        var listFromCache2 = cacheAllDs2.GetStreamTac(DataSourceConstants.StreamDefaultName)!.ListTac();
    ...
    public void ExpireBecauseOfTime()
    {
        ...
        // Get first list from direct query and from cache - compare. Should be same
        var originalList = cacheDs.GetStreamTac(DataSourceConstants.StreamDefaultName)!.ListTac();
        ...
        var listFromCacheAfter1Second = newCacheDs.GetStreamTac(DataSourceConstants.StreamDefaultName)!.ListTac();
