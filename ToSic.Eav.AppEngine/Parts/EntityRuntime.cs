...
namespace ToSic.Eav.Apps.Parts
{
    ...
    public class EntityRuntime: RuntimeBase
    {
        ...
        /// </summary>
        public IEnumerable<IEntity> All => App.Cache.List;
        ...
        /// </summary>
        public IEntity Get(int entityId) => App.Cache.List.FindRepoId(entityId);
        ...
        /// <returns></returns>
        public IEntity Get(Guid entityGuid) => App.Cache.List.One(entityGuid);

        public IEnumerable<IEntity> Get(string contentTypeName)
        {
            var typeFilter = DataSource.GetDataSource<EntityTypeFilter>(appId: App.AppId, upstream: App.Cache, configLookUp: App.Data.ConfigurationProvider); // need to go to cache, to include published & unpublished
