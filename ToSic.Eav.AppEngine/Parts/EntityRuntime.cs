...
namespace ToSic.Eav.Apps.Parts
{
    ...
    public class EntityRuntime: RuntimeBase
    {
        ...
        {
            var typeFilter = new DataSource(Log).GetDataSource<EntityTypeFilter>(/*appId: App.AppId, upstream:*/ App./*Cache*/Data /*,configLookUp: App.Data.ConfigurationProvider Log*/); // need to go to cache, to include published & unpublished
