...
namespace ToSic.Eav.Core.Tests.Configuration
{
    ...
    public class DataOverrideTest : TestBaseDiEavFullAndDb
    {
        ...
        private static Guid fancybox4ItemGuid = new Guid("3356ad17-91ce-4814-83c1-9f527697391a");
        private static Guid fancybox3ItemGuid = new Guid("4b9ef331-480a-4a38-86f1-a580f8345677");
