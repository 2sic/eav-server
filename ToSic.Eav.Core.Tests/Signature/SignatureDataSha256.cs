...
namespace ToSic.Eav.Core.Tests.Signature
{
  ...
  },
  {
    ...
    'favoriteFruit': 'strawberry'
            ...
            X509Certificate2 CertSelfSigned2048_SHA256 = new X509Certificate2(Convert.FromBase64String(SelfSigned2048_SHA256), "", X509KeyStorageFlags.Exportable);
            string exportedKeyMaterial = CertSelfSigned2048_SHA256.PrivateKey.ToXmlString(true);
            RSACryptoServiceProvider csp = new RSACryptoServiceProvider(new CspParameters(24 /* PROV_RSA_AES */));
            ...
            bool isValidSignature = cspPublic.VerifyData(dataClient, CryptoConfig.MapNameToOID("SHA256"), signatureClient);
