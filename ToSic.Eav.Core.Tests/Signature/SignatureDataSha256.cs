...
namespace ToSic.Eav.Core.Tests.Signature
{
    ...
    public class SignatureDataSha256
    {
        ...
        public void SignatureSha256ValidationTest()
        {
            ...
            var signatureBase64 = Sha256.SignBase64(SelfSigned2048_SHA256, data);
            ...
            var isValidSignature = Sha256.VerifyBase64(SelfSigned2048_SHA256_Public, signatureBase64, dataClient);
