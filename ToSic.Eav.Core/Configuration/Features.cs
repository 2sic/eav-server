...
namespace ToSic.Eav.Configuration
{
    ...
    public static class Features
    {
        ...
        private static string HelpLink => _helpLink ?? (_helpLink = Factory.StaticBuild<IEavDbConfiguration>().FeaturesHelpLink);
        private static string _helpLink;
        private static string InfoLinkRoot => _infoLinkRoot ?? (_infoLinkRoot = Factory.StaticBuild<IEavDbConfiguration>().FeatureInfoLinkRoot);
