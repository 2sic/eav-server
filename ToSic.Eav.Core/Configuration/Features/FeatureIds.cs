...
namespace ToSic.Eav.Configuration
{
    ...
    public class FeatureIds
    {
        ...
        public static Guid PublicForms => FeaturesCatalog.PublicEditForm.Id; // new Guid("d93baf71-74c6-4956-9fe0-8281acdfd14a");
        public static Guid PublicUpload => FeaturesCatalog.PublicUploadFiles.Id; // new Guid("79b9f5f8-d104-458b-8e8f-9f4a11c5935e");
        public static Guid UseAdamInWebApi => FeaturesCatalog.SaveInAdamApi.Id; // new Guid("ecdab0f6-4692-4544-b1e7-72581f489f6a");
        public static Guid PermissionCheckUserId => FeaturesCatalog.PermissionCheckUsers.Id; // new Guid("47c71ee9-ac7b-45bf-a08b-dfc8ce7c7775");
        public static Guid PermissionCheckGroups => FeaturesCatalog.PermissionCheckGroups.Id; // new Guid("0fd479cc-300f-47fd-88fd-8f2fe092bc09");
