...
namespace ToSic.Eav.Configuration.Licenses
{
    public class BuiltInLicenses
    {
        ...
        public static readonly LicenseDefinition System = new LicenseDefinition(FeatureSetSystem, 10000,
            "System",
            new Guid("fae8a2ac-cdeb-45f8-b690-cc4eee8a5690"),
        ...
        public static readonly LicenseDefinition Extension = new LicenseDefinition(FeatureSetExtension, 10001,
            "Extension",
            new Guid("8d0cef7a-1e11-456e-aae5-94ac21c0cc74"),
        ...
        public static readonly LicenseDefinition CoreFree = new LicenseDefinition(LicensePrefix + nameof(CoreFree), 1, 
        ...
        public static readonly LicenseDefinition CorePlus = new LicenseDefinition(LicensePrefix + nameof(CorePlus), 2,
        ...
        public static readonly LicenseDefinition PatronPerfectionist = new LicenseDefinition(LicensePrefix + nameof(PatronPerfectionist),121, 
        ...
        public static readonly LicenseDefinition PatronSentinel = new LicenseDefinition(LicensePrefix + nameof(PatronSentinel),122, 
            "Patron Sentinel",
        ...
        public static readonly LicenseDefinition PatronBasic = new LicenseDefinition(LicensePrefix + nameof(PatronBasic),101, 
            "Patron Basic",
        ...
        public static readonly LicenseDefinition PatronAdvancedCms = new LicenseDefinition(LicensePrefix + nameof(PatronAdvancedCms),102,
            "Patron Advanced CMS",
            new Guid("e23ef849-f50c-47a5-81dd-33fb17727305"),
            "Patrons with advanced needs in advanced CMS features."
        );

        public static readonly LicenseDefinition PatronSuperAdmin = new LicenseDefinition(LicensePrefix + nameof(PatronSuperAdmin),501,
            "Patron SuperAdmin",
            new Guid("4f1aa6d9-6360-4c60-97e9-643e3fd92061"),
            "Patrons with advanced needs in regards to automation, administration etc."
        );

        public static readonly LicenseDefinition PatronInfrastructure = new LicenseDefinition(LicensePrefix + nameof(PatronInfrastructure),501,
        ...
        public static readonly LicenseDefinition WebFarmCache = new LicenseDefinition(LicensePrefix + nameof(WebFarmCache),301, 
            "WebFarmCache",
        ...
        public static readonly LicenseDefinition EnterpriseCms = new LicenseDefinition(LicensePrefix + nameof(EnterpriseCms),702, 
            "EnterpriseCms",
        ...
        public static readonly LicenseDefinition CoreBeta = new LicenseDefinition(LicensePrefix + nameof(CoreBeta),1000,
            "Beta",
...
#if DEBUG
        public static readonly LicenseDefinition CoreTesting = new LicenseDefinition(LicensePrefix + nameof(CoreTesting), TestLicensesBaseId,
            "Testing",
