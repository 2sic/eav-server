...
namespace ToSic.Eav.Internal.Licenses
{
    public class BuiltInLicenses
    {
        ...
        public static readonly FeatureSet System = new FeatureSet(FeatureSetSystem, 10000,
            "System",
        ...
        public static readonly FeatureSet Extension = new FeatureSet(FeatureSetExtension, 10001,
            "Extension",
        ...
        public static readonly FeatureSet CoreFree = new FeatureSet(LicensePrefix + nameof(CoreFree), 1, 
        ...
        public static readonly FeatureSet CorePlus = new FeatureSet(LicensePrefix + nameof(CorePlus), 2,
        ...
        public static readonly FeatureSet PatronPerfectionist = new FeatureSet(LicensePrefix + nameof(PatronPerfectionist),121, 
        ...
        public static readonly FeatureSet PatronSentinel = new FeatureSet(LicensePrefix + nameof(PatronSentinel),122, 
            "Patron Sentinel",
        ...
        public static readonly FeatureSet PatronBasic = new FeatureSet(LicensePrefix + nameof(PatronBasic),101, 
            "Patron Basic",
        ...
        public static readonly FeatureSet PatronAdvancedCms = new FeatureSet(LicensePrefix + nameof(PatronAdvancedCms),102,
            "Patron Advanced CMS",
            new Guid("e23ef849-f50c-47a5-81dd-33fb17727305"),
            "Patrons with advanced needs in advanced CMS features."
        );

        public static readonly FeatureSet PatronSuperAdmin = new FeatureSet(LicensePrefix + nameof(PatronSuperAdmin),501,
            "Patron SuperAdmin",
            new Guid("4f1aa6d9-6360-4c60-97e9-643e3fd92061"),
            "Patrons with advanced needs in regards to automation, administration etc."
        );

        public static readonly FeatureSet PatronInfrastructure = new FeatureSet(LicensePrefix + nameof(PatronInfrastructure),501,
        ...
        public static readonly FeatureSet WebFarmCache = new FeatureSet(LicensePrefix + nameof(WebFarmCache),301, 
            "WebFarmCache",
        ...
        public static readonly FeatureSet EnterpriseCms = new FeatureSet(LicensePrefix + nameof(EnterpriseCms),702, 
            "EnterpriseCms",
        ...
        public static readonly FeatureSet CoreBeta = new FeatureSet(LicensePrefix + nameof(CoreBeta),1000,
            "Beta",
...
#if DEBUG
        public static readonly FeatureSet CoreTesting = new FeatureSet(LicensePrefix + nameof(CoreTesting), TestLicensesBaseId,
            "Testing",
