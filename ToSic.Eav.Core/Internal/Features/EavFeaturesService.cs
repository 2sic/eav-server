...
/// 2025-03-11 updated the `CacheTimestamp` property to use a backing field `_staticCacheTimestamp`, so WebFarmCache is working when feature is enabled
/// </remarks>
...
public class EavFeaturesService(FeaturesCatalog featuresCatalog) : IEavFeaturesService
{
    ...
    [PrivateApi]
    public long CacheTimestamp => _staticCacheTimestamp;
