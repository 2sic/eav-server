...
namespace ToSic.Eav.Security
{
    public partial class PermissionCheckBase
    {
        ...
        {
            if (!_features.Enabled(FeaturesBuiltIn.PermissionCheckUsers.Guid)) return false;
        ...
        {
            if (!_features.Enabled(FeaturesBuiltIn.PermissionCheckGroups.Guid)) return false;
