...
namespace ToSic.Eav.Security.Encryption
{
    public class Sha256
    {
        ...
        {
            var certificate = new X509Certificate2(System.Convert.FromBase64String(certificateBase64),
            ...
            var signatureBase64 = System.Convert.ToBase64String(signature);
        ...
        public static bool VerifyBase64(string publicCertBase64, string signatureBase64,
            byte[] dataClient)
        {
            var publicCert = new X509Certificate2(System.Convert.FromBase64String(publicCertBase64), "");
            var cspPublic = (RSACryptoServiceProvider)publicCert.PublicKey.Key;
            var signatureClient = System.Convert.FromBase64String(signatureBase64);
