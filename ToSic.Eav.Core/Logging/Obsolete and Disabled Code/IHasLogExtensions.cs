...
//        {
//            ((thingWithLog.Log as LogAdapter)?.GetContents() as Lib.Logging.Log)?.LinkTo(parentLog);
//            return thingWithLog;
//        }
//        public static T Init<T>(this T thingWithLog, ILog parentLog, string name) where T: IHasLog
//        {
//            ((thingWithLog.Log as LogAdapter)?.GetContents() as Lib.Logging.Log)?.LinkTo(parentLog, name);
//            return thingWithLog;
//        }
//    }
//}
