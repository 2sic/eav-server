...
namespace ToSic.Eav.DataSourceTests
{
    ...
    public class ValueFilterString: TestBaseEavDataSource
    {
        ...
        public void ValueFilter_SimpleText_MultiLang_Ca25x(bool table, bool ml, string city, int expected, string lang, string notes)
        {
            ...
            Assert.AreEqual(expected, vf.ListForTests().Count(), $"Should find exactly {expected} people with this city");
        }
        ...
        public void ValueFilter_SimpleTextFilterCIDefault()
        {
            ...
            Assert.AreEqual(Quarter, vf.ListForTests().Count(), "Should find exactly 2500 people with this city");
        }
        ...
        public void ValueFilter_SimpleTextFilterCSWithSomeNulls()
        {
            ...
            Assert.AreEqual(Quarter, vf.ListForTests().Count(), "Should find exactly 0 people with this city");
        }
       ...
       public void ValueFilter_SimpleTextFilterBeginsNone()
        ...
        public void ValueFilter_SimpleTextFilterNotContains()
        {
            ...
            vf.Value = "ch";
            Assert.AreEqual(5000, vf.ListForTests().Count(), "Should find exactly 5000 people with this city");
        }
        #endregion
        ...
        public void ValueFilter_FilterFieldSometimesNull()
        {
            ...
            Assert.AreEqual(2500, vf.ListForTests().Count(), "Should find exactly 250 people with this city");
        }
        ...
        public void ValueFilter_WithFallback()
        {
            ...
            vf.InForTests().Add(DataSourceConstants.FallbackStreamName, vf.InForTests()[DataSourceConstants.DefaultStreamName]);
