...
{
    private CodeInfoObsolete(string nameId, Version from, Version to, string? link = default, string? message = default)
        : base(CodeInfoTypes.Obsolete, nameId, from, to, link, message)
    { }
