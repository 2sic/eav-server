...
#pragma warning disable CS8625
        Func_ReturnValue_Assert<string>(ThisMethodName(), log => log.Quick(() => null as string)!, null, 2);
#pragma warning restore CS8625

    [Fact] public void Func_ReturnValue() => 
        Func_ReturnValue_Assert(ThisMethodName(), log => log.Quick(() => 7), 7, 2);

    [Fact] public void Func_EnabledTrue_ReturnValue() => 
        Func_ReturnValue_Assert(ThisMethodName(), log => log.Quick(() => 27, enabled: true), 27, 2);

    [Fact] public void Func_EnabledFalse_ReturnValue() => 
        Func_ReturnValue_Assert(ThisMethodName(), log => log.Quick(() => 42, enabled: false), 42, 0);
