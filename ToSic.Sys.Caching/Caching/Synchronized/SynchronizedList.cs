...
public class SynchronizedList<T>(ICacheExpiring upstream, Func<IImmutableList<T>> rebuild)
    : SynchronizedObject<IImmutableList<T>>(upstream, rebuild), IEnumerable<T>
{
    /// <summary>
