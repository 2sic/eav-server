...
internal class InsightsAttributePermissions(LazySvc<IAppStates> appStates) : InsightsProviderWeb(Link, helpCategory: HiddenFromAutoDisplay, connect: [appStates])
{
