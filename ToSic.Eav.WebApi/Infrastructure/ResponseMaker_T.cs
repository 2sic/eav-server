...
//{
//    public abstract class ResponseMaker<THttpResponseType> //: IResponseMaker<THttpResponseType>
//    {
...
//        public abstract THttpResponseType File(string fileContent, string fileName, string fileType);
//        //{
