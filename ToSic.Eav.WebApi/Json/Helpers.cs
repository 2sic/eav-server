...
namespace ToSic.Eav.WebApi.Json
{
	/// <summary>
	...
	public class Helpers
	{
		...
		public static Dictionary<string, IEnumerable<Dictionary<string, object>>> GetStreamsForJson(IDictionary<string, ToSic.Eav.DataSources.IDataStream> streams, bool addEntityId = true, bool addEntityGuid = true)
		{
