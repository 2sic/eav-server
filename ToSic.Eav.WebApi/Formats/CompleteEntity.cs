...
namespace ToSic.Eav.WebApi.Formats
{
    ...
    //        {
    //            if(value > 10)
    //                throw new Exception("Unexpected TargetType (AssignmentObjectTypeId) - currently only expecting 1-4 or 10, got something else");
    //            _targetType = value;
    //        }
    //    }
    ...
    //                _keyType = newType;
    //            else
    //                throw new Exception("metadata key-type unknown. expected number, guid or string" );
    //        } 
    //    }
    ...
    //    /// <summary>
    //    /// The Ke Number is null or the int of the key as stored in "Key"
    //    /// </summary>
