...
/// </summary>
[ModelSpecs(
    ContentType = ContentTypeSettingsGeneral.MyTypeNameId
)]
public interface IContentTypeSettingsGeneral
{
    ...
    string EditInstructions { get; init; }
    string ListInstructions { get; init; }

    /// <summary>
    /// Lists all names of settings (AppSettings) to load when editing this content-type, as it will be needed in Formulas
    /// </summary>
    string AdditionalSettings { get; init; }

    string DynamicChildrenField { get; init; }
}
...
internal record ContentTypeSettingsGeneral : RawEntity, IContentTypeSettingsGeneral
{
    public const string MyTypeNameId = "ContentType";
