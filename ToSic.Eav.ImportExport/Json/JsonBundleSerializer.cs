...
namespace ToSic.Eav.ImportExport.Json
{
    ...
    {
        public JsonBundleSerializer(ITargetTypes metadataTargets, IAppStates appStates, EntityBuilder entityBuilder) : base(metadataTargets, appStates, entityBuilder, "Ser.Bundle") { }
