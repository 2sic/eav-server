...
namespace ToSic.Eav.DataSources.Caching
{
    ...
    public interface IListCache
    {
        ...
        ListCacheItem GetOrBuild(IDataStream stream, Func<ImmutableArray<IEntity>> builderFunc, int durationInSeconds = 0);
        ...
        void Set(string key, ImmutableArray<IEntity> list, long sourceTimestamp, int durationInSeconds = 0, bool slidingExpiration = true);
