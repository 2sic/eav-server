...
namespace ToSic.Eav.DataSources
{
	...
	public class DataStream : IDataStream
	{
		...
		public DataStream(IDataSource source, string name, /*GetDictionaryDelegate dictionaryDelegate*/ /* fake thing to find uses*/ IEntity xyz, GetIEnumerableDelegate lightListDelegate = null, bool enableAutoCaching = false)
		{
			Source = source;
			Name = name;
