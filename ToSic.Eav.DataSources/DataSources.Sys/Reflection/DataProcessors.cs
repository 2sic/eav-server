...
public class DataProcessors(CustomDataSource.Dependencies services, LazySvc<IEnumerable<IWorkEntityAction>> servicesOfType)
    : RegisteredClasses<IWorkEntityAction>(services, servicesOfType);