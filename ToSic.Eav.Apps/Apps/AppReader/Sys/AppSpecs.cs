...
internal class AppSpecs(AppState appState): IAppSpecs
{
    ...
    public IAppConfiguration Configuration => appState.SettingsInApp.AppConfiguration.As<AppConfiguration>(skipTypeCheck: true, /*nullIfNull: false,*/ nullHandling: ModelNullHandling.PreferModelForce)!;
