...
namespace ToSic.Eav.DataSources.Sys
{
    ...
    public sealed class Zones: DataSource
	{
        ...
        /// </summary>
        [PrivateApi]
		public Zones(Dependencies dependencies, IZoneMapper zoneMapper, IAppStates appStates, IDataBuilder dataBuilder): base(dependencies, $"{DataSourceConstants.LogPrefix}.Zones")
        {
            ConnectServices(
